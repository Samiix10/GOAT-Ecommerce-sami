            ...
            <ul className="d-flex gap-3 m-0 p-2">
              ...
              <li className="dropdown">
                <span className="d-flex align-items-center h-100 user-Menu" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <i className="fa-solid fa-user-check fa-2xl" style={{color: "#ffffff"}}></i>
                </span>
                <ul className="dropdown-menu user-Drop-Menu" id="Drop">
                  <li className="DropUserInfo"><Link to={"/User-Profile"}>Profile</Link></li>
                    <li className="DropUserInfo " onClick={() => HandlingLoged()}><Link className="w-100 d-block px-0 text-center">
                    log out
                    </Link></li>
                </ul>
              </li>
